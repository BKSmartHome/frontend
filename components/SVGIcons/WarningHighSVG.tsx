...
export const WarningHighSVG: ISvgComponent = ({
  width = "100%",
  height = "100%",
  className = "",
}) => {
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        {" "}
        <g id="tree" /> <g id="plant" /> <g id="flower" /> <g id="flower_pot" />{" "}
        <g id="rose" /> <g id="garden" /> <g id="fance" /> <g id="floral" />{" "}
        <g id="sunflower" /> <g id="sprinkle" /> <g id="water_hose" />{" "}
        <g id="planting" />{" "}
        <g id="fertilizer">
          {" "}
          <g>
        ...
        <g id="bee" /> <g id="butterfly" /> <g id="shovel" /> <g id="ladybug" />{" "}
        <g id="watering" /> <g id="hanging_pot" /> <g id="green_house" />{" "}
      </g>
    </svg>
  );
};
