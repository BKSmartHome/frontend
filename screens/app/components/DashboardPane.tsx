...
export type TDeviceStatus = "ON" | "OFF";
    ...
    return (
      <div className="flex gap-8">
        ...
        <div
          ...
          className={`flex flex-col gap-4 items-center justify-center grow  rounded-lg cursor-pointer hover:scale-105 duration-150 ${
            data?.fan == "1" ? "bg-blue-800" : "bg-blue-300"
          }`}
        >
    ...
    return (
      <div className="flex gap-8">
        ...
        <div
          ...
          className={`flex flex-col gap-4 items-center justify-center grow  rounded-lg cursor-pointer hover:scale-105 duration-150 ${
            data?.led == "1" ? "bg-gray-800" : "bg-gray-500"
          }`}
        >
          <span className="text-white font-bold text-xl ">
            {data?.led === "1" ? "ON" : "OFF"}
          </span>
          <LightBulbIcon className="w-12 h-12" color="white" />
        </div>
      </div>
    );
  };
    ...
    return (
      <div className="flex gap-8">
        ...
        <div
          ...
          className={`flex flex-col gap-4 items-center justify-center grow  rounded-lg cursor-pointer hover:scale-105 duration-150 ${
            data?.pump == "1" ? "bg-teal-600" : "bg-teal-200"
          }`}
        >
          <span className="text-white font-bold text-xl ">
            {data?.pump === "1" ? "ON" : "OFF"}
          </span>
          <PowerIcon className="w-12 h-12" color="white" />
        </div>
      </div>
    );
  };
